...
return;
  ...
  create(cancel = false): void {
    ...
    if (cancel) {
      ...
      if (this.stakeholderGroups)
        this.selectStakeholderGroups(this.stakeholderGroups);
  ...
  edit(
    ...
    if (cancel) {
      ...
      if (
        ...
        updatedValues.criteriaTags != this.criteriaTags
      ) {
      ...
      if (
        ...
        updatedValues.archetypeTags != this.archetypeTags
      ) {
      ...
      if (
        ...
        updatedValues.stakeholders != this.stakeholders
      ) {
  ...
  duplicate(
    ...
    criteriaTags
      ? this.selectCriteriaTags(criteriaTags)
    ...
    stakeholders
      ? this.selectStakeholders(stakeholders)
  ...
  public static verifyColumnValue(
    name: string,
    column: string,
    value: string
  ): void {
